...
print("I am the correct uniswap")
...
class Uniswap:
    ...
    def __init__(
        ...
        print(f'The current version is set as {self.version}')
        if self.version == 1:
            ...
            print(self.netname, "The current network is")

            if self.netname != "arbitrum_testnet":
            ...
            elif self.netname == "optimism_testnet":
                factory_contract_address = _str_to_addr(
                ...
                self.router_address = _str_to_addr(
                    "0xBFB197dAB8ADC9560F32198CFA5454beBE2655A0"
                )
                self.router = _load_contract(
                    self.w3, abi_name="uniswap-v3/router", address=self.router_address
                )
                ...
                quoter_addr = _str_to_addr("0x61fFE014bA17989E743c5F6cB21bF9697530B21e")
                self.quoter = _load_contract(
                    self.w3, abi_name="uniswap-v3/quoter", address=quoter_addr
                )
    ...
    def _get_token_token_input_price(
        ...
        if self.version == 2:
            ...
            sqrtPriceLimitX96 = 0
            print(f"in checking the price functions, token0 is {token0}, token1 is {token1}, fee is {fee}. qty is {qty}, sqrtPrice is {sqrtPriceLimitX96}")
