...
chain_list={
    'bsc':{
        ...
        'scan_api_key':'RETP86D5K182EEERHME97NZ5K1GHZAZRKU',
    ...
    ,        'anker_token':"d1815f27533d77e12ffacc481c2a493dcb17f7552d40ed5568f3488a4c9fe0fa"

    },
    'eth':{
        'rpc_url':'https://late-distinguished-liquid.ethereum-goerli.quiknode.pro/c223fc49ad91d40d790dc09e075ee034b949f6e9/',
        'router_address':'0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D',
        'scan_api_key': 'B8KJQHWZH698BSGDSA4H2TIUJ1XMPXN1UA',
        'router_abi':'''[
    {
        "inputs": [
            {
    ...
    },
    {
        ...
        'w_address':'0xb4fbf271143f4fbf7b91a5ded31805e42b2208d6',
        'web3':Web3(Web3.HTTPProvider('https://late-distinguished-liquid.ethereum-goerli.quiknode.pro/c223fc49ad91d40d790dc09e075ee034b949f6e9/')),
        'base_scan_url':"https://api-goerli.etherscan.io/api?",
        'leverage_wallet_address':"0xB6EE76c3a25b0644390471Bc6ee3D1161Ecfbd4C",
        'leverage_wallet_abi':'''[
			{
				"inputs": [],
				"stateMutability": "nonpayable",
    ...
    'arb':{
        'rpc_url':'https://arb-goerli.g.alchemy.com/v2/9hOBRz0xhx0b9zVnE5jMsi7Wgge7Tyll',
        'web3':Web3(Web3.HTTPProvider('https://arb-goerli.g.alchemy.com/v2/9hOBRz0xhx0b9zVnE5jMsi7Wgge7Tyll')),
        'anker_token':"d1815f27533d77e12ffacc481c2a493dcb17f7552d40ed5568f3488a4c9fe0fa"
